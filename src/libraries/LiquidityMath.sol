...
/// @title LiquidityMath Library
/// @notice Provides utilities for calculating liquidity for given token amounts
library LiquidityMath {
    /// $L = \frac{\Delta x \sqrt{P_u} \sqrt{P_l}}{\Delta \sqrt{P}}$
    /// @notice Calculates liquidity for a given amount of token0 and price range
    /// @param sqrtPriceAX96 The lower square root price as a Q96.96 value
    /// @param sqrtPriceBX96 The upper square root price as a Q96.96 value
