...
contract UniswapV3ManagerTest is Test, TestUtils {
    ...
    function setUp() public {
        ...
        weth = new ERC20Mock("Ether", "ETH");
        uni = new ERC20Mock("UNI", "UNI");
    ...
    function testMintInRange() public {
        (IUniswapV3Manager.MintParams[] memory mints, uint256 poolBalance0, uint256 poolBalance1) = setupPool(
            PoolParams({
                wethBalance: 1 ether,
    ...
    function testMintOverlappingRanges() public {
        ...
        assertMany(
            ExpectedPoolAndBalances({
                ...
                tick: tick(5000),
                fees: [uint256(0), 0],
                userBalances: [3 ether - amount0, 15_000 ether - amount1],
    ...
    function testSwapBuyEth() public {
        ...
        assertMany(
            ExpectedMany({
                ...
                tokens: [weth, usdc],
                liquidity: liquidity(mints[0], 5000),
                sqrtPriceX96: 5_604_422_590_555_458_105_735_383_351_329, // 5003.830413717752
                tick: 85_183,
                fees: [
                    uint256(0),
                    27_727_650_748_765_949_686_643_356_806_934_465 // 0.000081484242041869
                ],
    ...
    function testSwapBuyUSDC() public {
        ...
        assertMany(
            ExpectedMany({
                ...
                tokens: [weth, usdc],
                liquidity: liquidity(mints[0], 5000),
                sqrtPriceX96: 5_598_864_267_980_327_381_293_641_469_695, // 4993.909994249256
                tick: 85_164,
                fees: [
                    uint256(8_826_635_488_357_160_650_248_135_250_207), // 0.000000025939150383
                    0
                ],
    ...
    function testSwapBuyMultipool() public {
        ...
        uint256 amountOut = manager.swap(
            IUniswapV3Manager.SwapParams({ path: path, recipient: address(this), amountIn: swapAmount, minAmountOut: 0 })
        );
        ...
        assertMany(
            ExpectedMany({
                ...
                sqrtPriceX96: 5_539_583_677_789_714_904_297_843_583_839, // 4888.719128166855
                tick: 84_951,
                fees: [
                    uint256(163_879_779_853_250_804_931_705_964_313_699), // 0.000000481599388579
                    0
                ],
        ...
        assertMany(
            ExpectedMany({
                ...
                sqrtPriceX96: 251_566_706_235_579_008_314_845_847_774, // 10.082010831439806
                tick: 23_108,
                fees: [
                    uint256(0),
                    13_250_097_234_547_358_482_322_170_106_940_574 // 0.000038938536117641
                ],
    ...
    function testSwapMixed() public {
        ...
        assertMany(
            ExpectedMany({
                ...
                tokens: [weth, usdc],
                liquidity: liquidity(mints[0], 5000),
                sqrtPriceX96: 5_601_673_842_247_623_244_689_987_477_875, // 4998.923254346182
                tick: 85_174,
                fees: [
                    uint256(8_826_635_488_357_160_650_248_135_250_207), // 0.000000025939150383
                    36_310_018_837_669_696_018_223_443_437_652_275 // 0.000106705555054829
                ],
    ...
    function mintParams(IUniswapV3Manager.MintParams memory mint1, IUniswapV3Manager.MintParams memory mint2)
        internal
        pure
        returns (IUniswapV3Manager.MintParams[] memory mints)
    {
    ...
    function mintParamsToTicks(IUniswapV3Manager.MintParams memory mint, uint256 currentPrice)
        internal
        pure
    ...
    function setupPool(PoolParams memory params)
        internal
        returns (IUniswapV3Manager.MintParams[] memory mints_, uint256 poolBalance0, uint256 poolBalance1)
    {
